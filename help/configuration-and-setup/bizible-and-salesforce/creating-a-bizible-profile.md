...
1. Log-in to your Bizible Account and re-authorize the Salesforce connection with the new user:
   ...
   If you have any questions around creating a dedicated Bizible profile, please reach out to your success manager or [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#671412171708151327050e1d0e050b024904080a).
